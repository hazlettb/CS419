...
#****************************************************************************************
# ** Function: move_down
# ** Description: moves cursor down one line in the calendar window
# ** Input Parameters: cal_window, y_cal, x_cal
# ** Output:  y_cal, x_cal
#****************************************************************************************
...
#****************************************************************************************
# ** Function: time_down
# ** Description: moves cursor down one line in the date window
# ** Input Parameters: date_window, outer_window, y_date, x_date
# ** Output:  y_date, x_date
#****************************************************************************************	
...
#****************************************************************************************
# ** Function: move_up
# ** Description: moves cursor up one line in the calendar window
# ** Input Parameters: cal_window, y_cal, x_cal
# ** Output:  y_cal, x_cal
#****************************************************************************************	
...
#****************************************************************************************
# ** Function: time_up
# ** Description: moves cursor up one line in the date window
# ** Input Parameters: date_window, outer_window, y_date, x_date
# ** Output:  y_date, x_date
#****************************************************************************************	
...
#****************************************************************************************
# ** Function: move_right
# ** Description: moves cursor right three spaces in the calendar window
# ** Input Parameters: cal_window, y_cal, x_cal
# ** Output:  y_cal, x_cal
#****************************************************************************************	
...
#****************************************************************************************
# ** Function: move_left
# ** Description: moves cursor left three spaces in the calendar window
# ** Input Parameters: cal_window, y_cal, x_cal
# ** Output:  y_cal, x_cal
#****************************************************************************************		
...
#****************************************************************************************
# ** Function: plus_month
# ** Description: displays next month in calendar window
# ** Input Parameters: month, year, cal_window
# ** Output:  month, year
#****************************************************************************************	
...
# ** Description: displays previous month in calendar window
# ** Input Parameters: month, year, cal_window
# ** Output:  month, year
#****************************************************************************************	
...
#****************************************************************************************
# ** Function: toggle
# ** Description: toggles cursor between date and calendar windows (true = calendar window,
# ** false = date window)
# ** Input Parameters: cal_toggle, outer_window, date_window, cal_window
# ** Output:  cal_toggle
#****************************************************************************************	
...
#****************************************************************************************
# ** Function: display_appt
# ** Description: queries database for appointments on date_choice and returns a list or error 
# ** Input Parameters: date_window, cal_window, y_cal, x_cal, month, year, ad_email, lst, date_choice
# ** Output:  y_cal, x_cal, lst
#****************************************************************************************		
def display_appt(date_window, cal_window, y_cal, x_cal, month, year, ad_email, lst, date_choice):	
	...
	#validate date_choice and change format if needed
	#pdb.set_trace(), tried for debugging but not useful!
...
# ** Description: calls program to send plain text email for selected time 
# ** Input Parameters: outer_window, y_date, x_date, ad_email, lst
# ** Output:  none
#****************************************************************************************		
def cancel_appt(outer_window, y_date, x_date, ad_email, lst):
	...
	#check that it is an appointment
	if time_choice == "No ap" or time_choice == "     " or time_choice == "Inval":
		return
	...
	#show messsage, pause and hide cancel window
	cancel_win.refresh()
	time.sleep(3) 			
	cancel_win.erase()	
...
#****************************************************************************************
# ** Function: cursor_nav
# ** Description: displays navigation key help in calendar window 
# ** Input Parameters: cal_window
# ** Output:  none
#****************************************************************************************	
...
def main(screen):
	...
	#Initialize the color combinations
	...
	#Change the q to red, t to green, d to green, c to red, p/m to green
	stdscr.chgat(curses.LINES-1,0,1,curses.A_BOLD | curses.color_pair(1))
	stdscr.chgat(curses.LINES-1,9,1,curses.A_BOLD | curses.color_pair(2))
	stdscr.chgat(curses.LINES-1,20,1,curses.A_BOLD | curses.color_pair(2))
	stdscr.chgat(curses.LINES-1,37,1,curses.A_BOLD | curses.color_pair(1))
	stdscr.chgat(curses.LINES-1,53,1,curses.A_BOLD | curses.color_pair(2))
	stdscr.chgat(curses.LINES-1,55,1,curses.A_BOLD | curses.color_pair(2))
	...
	while True:
		...
		if c == ord('q') or c == ord('Q'): #end program			
			...
			if cal_toggle == True:
				...
				if date_choice == "  ":
					date_window.addstr(4,2, "                              ")
					date_window.addstr(4,4, "Invalid Date")
					date_window.addstr(1,16, date_choice) 
					date_window.noutrefresh()				
				else:
					y_cal, x_cal, lst = display_appt(date_window, cal_window, y_cal, x_cal, month, year, ad_email, lst, date_choice)
