...
# CS 419 - Group 4
# rev1: 3/15/2015
# This program sends a plaintext email when supplied the 
# advisor's email, appointment list and appointment time_choice.
# Help sources:
...
class email:
	def cancel(self, ad_email, lst, time_choice):
		...
		#create header
		receivers = [ad_email] #3/13 removed stu_email
		headers = ["From: " + sender,
			   "Subject: " + subject,
